        ...
        <div class="row">
            <div class="col s12">
                <ul class="tabs">
                    ...
                    <li class="tab col s4 "><a href="#approve_tbl" id="approve" class="black-text">Approve Post Requests</a></li>
                    <br>
                </ul>
            </div>
        </div>
            ...
            <?php if(is_array($approve) || is_object($approve)){
              foreach ($approve as $approval) {
                if($approval->post_picture == '' || $approval->post_picture ==null){
                  ...
                  <td><img class="Boxing" src="'.base_url('assets/files/noimages.png').'" height="auto" width="100%"></td>
                  ...
                  <tr id="'.$approval->post_ID.'">
                  <td><p>'.$approval->accounts_fname."\t".$approval->accounts_lname.'</p></td>
                  <td><img class="Boxing" src="'.base_url('assets/files/'.$approval->post_picture).'" height="auto" width="100%"></td>
